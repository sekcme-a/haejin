...
const Hrd = () => {
  ...
  고객 감동서비스를 경영이념으로 실천하며 선진화 된 경영관리 방법을 현장에 적용하기 위해 각 분야의 전문적인 인재채용과 인사관리 업무를 관리 및 지원하고 있습니다.`,
    ...
    list: [
      {title: "우수인력 채용", content:"아파트관리 분야의 우수인력을 투명하고 공정하게 선발하여 함께 성장해나가는 혜진종합관리 인력관리 시스템을 운영하고 있습니다."},
      {title:"직원관리 프로그램", content:"아파트관리 분야의 우수인력을 투명하고 공정하게 선발하여 함께 성장해나가는 혜진종합관리 인력관리 시스템을 운영하고 있습니다."}
    ],
    title1:"통합교육",
  ...
  return(
    <div className={styles.main_container}>
      ...
      <motion.ul className={styles.list1_container} ref={inViewRef2} {...initial()} animate={ani2_1}>
        <EditButton type="hrd" item="list" text="내용" mode="arrOfObj_list"/>
